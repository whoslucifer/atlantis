  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      general = {
        ...
        "col.active_border" = "rgba(4f4256CC)";
      ...
      in [
        ...
        "Alt, Tab, exec, wezterm start -- bash"
        "Super, Tab, exec, wezterm"
      ...
      bindle = [
        ...
        "Alt+,XF86MonBrightnessUp, exec, ags run-js 'brightness.screen_value += 0.005;indicator.popup(1);'"
        "Alt+,XF86MonBrightnessDown, exec, ags run-js 'brightness.screen_value -= 0.005;indicator.popup(1);'"
      ...
      windowrule = [
        ...
        "size 400 700, .protonvpn-app-wrapped"
